...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        LocalizationManager.shared.setupInitLanguage()
        ...
        NetworkMonitor.shared.setupNotifier()
...
//        _ = NetworkHandler()
//        NetworkHandler.shared.startMonitor()
    }
...
extension AppDelegate: LocalizationDelegate {
    func resetApp() {
        ...
        UIView.transition(with: window, duration: 0.3, options: option, animations: nil, completion: nil)
    }
}
